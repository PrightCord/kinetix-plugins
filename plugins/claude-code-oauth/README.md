...
- an Anthropic provider template using `https://api.anthropic.com/v1` and carrying the required Anthropic API version and OAuth beta headers.
...
The resulting package is `dev.kinetix.claude-code-oauth-0.1.4.kxp`.
